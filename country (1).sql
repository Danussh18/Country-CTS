...
use db_cognizant;
show tables;
create table STUDENT(STUD_ID integer primary key, STUD_NAME varchar(30), STUD_EMAIL VARCHAR(30), STUD_MOBILE VARCHAR(30));
select * from country;
use ormlearn;
delete from country where co_code="IN";
delete from country where co_code="US";
